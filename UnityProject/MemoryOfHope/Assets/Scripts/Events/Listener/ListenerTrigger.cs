...
public class ListenerTrigger : MonoBehaviour
{
    ...
    [SerializeField]
    protected UnityEvent _endTriggerListeners;
    [SerializeField]
    protected bool _destroyWhenTrigger;
    [SerializeField]
    protected float _timeToDestroyWhenTrigger;

    [SerializeField]
    protected bool _destroyWhenEndTrigger;
    [SerializeField]
    protected float _timeToDestroyWhenEndTrigger;
